...
public class AbilityUpgradeData : ScriptableObject
{
    ...
    [Header("Tier VFX")]
    [Tooltip("This ability's Cue Book — the Upgrade Data Editor shows it side-by-side and authors " +
             "<id>_tN tier-variant ids into it. Config-only link (R7): runtime cue resolution still " +
             "receives the book from the ability system (UpgradeCueResolver).")]
    public CueBookData cueBook;
