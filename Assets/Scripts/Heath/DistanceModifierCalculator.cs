...
//   1. Upgrade bonus now guarded by d <= upgradeCapDistance (16u per GDD §6.2).
...
public class DistanceModifierCalculator : IDistanceModifierCalculator
{
    ...
    public float CalculateModifier(float distance, int upgradeNode)
    {
        ...
        // GDD §6.2: bonus ONLY when distance is within the upgradeable range.
