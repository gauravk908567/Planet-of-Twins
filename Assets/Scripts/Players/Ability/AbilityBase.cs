...
public abstract class AbilityBase : IAbility, IAbilityHUDSource
{
    ...
    /// <summary>Bench cheat (GameDebuggerV2): make the ability instantly ready. Not for gameplay code.</summary>
    public void DebugClearCooldown() => _lastUseTime = float.NegativeInfinity;
