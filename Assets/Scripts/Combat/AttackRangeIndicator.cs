...
public class AttackRangeIndicator : MonoBehaviour
{
    ...
    {
        // Dev-only: the coloured range circle is a debug aid, not a shipping visual (user call
        // 2026-07-09 -- cue-driven telegraphs replaced the flat circles). Trainer builds keep it.
