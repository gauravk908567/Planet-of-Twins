...
public class QTEManager : MonoBehaviour
{
    ...
    private void Update()
    {
        switch (_phase)
        {
            ...
            case QTEPhase.Mashing:
                ...
                if (ActiveDef != null && Input.GetKeyDown(ActiveDef.mashKey))
                    _mashCount++;
                ...
                if (_timerRing != null)
                {
                    _timerRing.fillAmount = mashDur > 0f
                        ? Mathf.Clamp01(_mashTimer / mashDur) : 0f;
    ...
    private void BeginMashPhase()
    {
        ...
        if (_timerRing != null) { _timerRing.fillAmount = 1f; _timerRing.color = activeColour; }
    ...
    {
        _rootPanel = null; _fillBar = null; _timerRing = null;
