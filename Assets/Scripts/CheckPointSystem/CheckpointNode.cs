...
/// nodes' occupants to decide when both twins are present. The per-node burst VFX (clan colour) will read
/// <see cref="IsOccupied"/> + the parent's state in the visual pass — not wired yet.
///
